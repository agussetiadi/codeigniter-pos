...
<div id="modal1" class="modal fade" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-md" role="document">
    ...
    <form action="<?php echo base_url()."master/bank/add_bank" ?>" method="POST" class="ajax_form">
	    ...
	    <div class="modal-body">
	    	<div class="form-group">
				...
				<input type="text" class="form-control" name="bank_name" placeholder="Nama Pembayaran">
			</div>
...
<div id="modal2" class="modal fade" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-md" role="document">
    ...
    <form action="<?php echo base_url()."master/bank/update_bank/" ?>" method="POST" class="ajax_form">
...
<script>
        var dataTable = $('#lookup').DataTable( {
            ...
            "searching": true,
            "ajax":{
                url :"<?php echo base_url() ?>"+"master/bank/view_all", // json datasource
...
$(document).on("click", ".btn-edit", function(){
	...
	$("input[name=bank_id]").val($(".bank_id").eq(index).val())
	$("input[name=bank_name]").val($(".bank_name").eq(index).val())
