...
<div id="modal1" class="modal fade" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-md" role="document">
    ...
    <form action="<?php echo base_url()."master/category/add_category" ?>" method="POST" class="ajax_form">

    	<div class="modal-header">
	    	<h4 class="text-center">Tambah Kategori Item</h4>
	    </div>
	    <div class="modal-body">
	    	<div class="form-group">
				<label>Jenis Kategi Item</label>
				<input type="text" class="form-control" name="category_name" placeholder="Tuliskan Jenis Category">
			</div>
...
<div id="modal2" class="modal fade" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-md" role="document">
    ...
    <form action="<?php echo base_url()."master/category/update_category/" ?>" method="POST" class="ajax_form">

    	<div class="modal-header">
	    	<h4 class="text-center">Edit Category Item</h4>
	    </div>
	    <div class="modal-body">
	      	<div class="form-group">
				<label>Jenis Kategi Item</label>
...
<script>
        var dataTable = $('#lookup').DataTable( {
            ...
            "searching": true,
            "ajax":{
                url :"<?php echo base_url() ?>"+"master/category/view_all", // json datasource
...
$(document).on("click", ".btn-edit", function(){
	...
	$("input[name=category_id]").val($(".category_id").eq(index).val())
	$("input[name=category_name]").val($(".category_name").eq(index).val())
