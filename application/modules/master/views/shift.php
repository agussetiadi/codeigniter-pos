...
<div id="modal1" class="modal fade" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-md" role="document">
    ...
    <form action="<?php echo base_url()."master/shift/add_shift" ?>" method="POST" class="ajax_form">
	    ...
	    <div class="modal-body">
	    	<div class="form-group">
				...
				<input type="text" class="form-control" name="shift_name" placeholder="Tuliskan shift karyawan : Pagi/Siang/Sore/Malam/dll">
			</div>
...
<div id="modal2" class="modal fade" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-md" role="document">
    ...
    <form action="<?php echo base_url()."master/shift/update_shift/" ?>" method="POST" class="ajax_form">
...
<script>
        var dataTable = $('#lookup').DataTable( {
            ...
            "searching": true,
            "ajax":{
                url :"<?php echo base_url() ?>"+"master/shift/view_all", // json datasource
...
$(document).on("click", ".btn-edit", function(){
	...
	$("input[name=shift_id]").val($(".shift_id").eq(index).val())
	$("input[name=shift_name]").val($(".shift_name").eq(index).val())
