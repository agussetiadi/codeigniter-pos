...
<div id="modal1" class="modal fade" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-md" role="document">
    ...
    <form action="<?php echo base_url()."master/jabatan/add_jabatan" ?>" method="POST" class="ajax_form">

    	<div class="modal-header">
	    	<h4 class="text-center">Tambah Waktu Shift</h4>
	    </div>
	    <div class="modal-body">
	    	<div class="form-group">
				<label>Waktu Shift</label>
				<input type="text" class="form-control" name="jabatan_name" placeholder="Tuliskan Jabatan/Divis : Design/Supervisor/CS/DLL">
			</div>
...
<div id="modal2" class="modal fade" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-md" role="document">
    ...
    <form action="<?php echo base_url()."master/jabatan/update_jabatan/" ?>" method="POST" class="ajax_form">

    	<div class="modal-header">
	    	<h4 class="text-center">Edit Waktu Shit</h4>
	    </div>
	    <div class="modal-body">
	    	<div class="form-group">
				<label>Waktu Shift</label>
				<input type="text" class="form-control" name="jabatan_name" placeholder="Tuliskan Jabatan/Divis : Design/Supervisor/CS/DLL">
				<input type="hidden" class="form-control" name="jabatan_id">
			</div>
		</div>
...
<script>
        var dataTable = $('#lookup').DataTable( {
            ...
            "searching": true,
            "ajax":{
                url :"<?php echo base_url() ?>"+"master/jabatan/view_all", // json datasource
...
$(document).on("click", ".btn-edit", function(){
	...
	$("input[name=jabatan_id]").val($(".jabatan_id").eq(index).val())
	$("input[name=jabatan_name]").val($(".jabatan_name").eq(index).val())
