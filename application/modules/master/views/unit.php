...
<div id="modal1" class="modal fade" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-md" role="document">
    ...
    <form action="<?php echo base_url()."master/unit/add_unit" ?>" method="POST" class="ajax_form">

    	<div class="modal-header">
	    	<h4 class="text-center">Tambah Data Satuan</h4>
	    </div>
	    <div class="modal-body">
	    	<div class="form-group">
				<label>Jenis Satuan</label>
				<input type="text" class="form-control" name="unit_name" placeholder="Tuliskan jenis satuan sepert : lbr/mtr/pcs/dll">
			</div>
...
<div id="modal2" class="modal fade" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-md" role="document">
    ...
    <form action="<?php echo base_url()."master/unit/update_unit/" ?>" method="POST" class="ajax_form">
...
<script>
        var dataTable = $('#lookup').DataTable( {
            ...
            "searching": true,
            "ajax":{
                url :"<?php echo base_url() ?>"+"master/unit/view_all", // json datasource
...
$(document).on("click", ".btn-edit", function(){
	...
	$("input[name=unit_id]").val($(".unit_id").eq(index).val())
	$("input[name=unit_name]").val($(".unit_name").eq(index).val())
