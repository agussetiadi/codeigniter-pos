		...
		<div class="col-md-12">
			<div class="block-space">
				<div class="row" style="margin-bottom: 50px">
					<div class="col-md-3">
						<input class="form-control searchData" name="" placeholder="Cari berdasar kata kunci" list="item" value="<?php echo $get_item_name ?>">
						<datalist id="item">
					...
					<div class="col-md-6">
		      			...
		      			<input type="text" class="in-search float-right datepicker" placeholder="Tanggal" name="date" value="<?php echo $dateNow ?>">
...
<script type="text/javascript">
		if ($("#btn-next").length == 0) {
			$("tfoot").html('<td colspan="6"><button id="btn-pre" class="btn btn-info btn-sm"> Previous </button> <input style="width:30px" type="text" id="start" value="1"> <button id="btn-next" class="btn btn-info btn-sm"> Next </button></td><td colspan="2" id="total"></td><td></td>');
		}
		...
		$.ajax({
			url:"<?php echo base_url() ?>"+"inventory/stock_card/get_detail",
			method : "POST",
