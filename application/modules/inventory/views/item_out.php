...
<!-- Page Header-->
  <header class="page-header">
    <div class="container-fluid">
    	<div class="row">
	      <div class="col-md-6"><h2 class="no-margin-bottom">Stock Keluar</h2></div>
	      <div class="col-md-6">
	      	<button class="btn btn-success float-right" id="rdr">Tambah Stock Keluar</button>
	      </div>
      	</div>
    </div>
  </header>
...
<script type="text/javascript">
    ...
    $.ajax({
      url:"<?php echo base_url() ?>"+"inventory/stock_flow/get_item_out",
      method : "POST",
  ...
  $(document).on("click","#rdr", function(){
    document.location='<?php echo base_url()."inventory/stock_flow/add?init=out&store=" ?>'+ $("select[name=store]").val();
  })
